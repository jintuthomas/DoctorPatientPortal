...
<head>
    <title>Poly Clinic Medical Category Bootstrap Responsive website Template | Typography :: w3layouts</title>
    ...
    <section class="wthree-row pt-sm-3  pb-sm-5 pb-3">
        <div class="container py-sm-5 py-3">
            ...
            <div class="title-section text-center pb-lg-5">
                ...
                <h3 class="w3ls-title text-center text-capitalize">Typography</h3>
            </div>
            <!-- //section title -->
