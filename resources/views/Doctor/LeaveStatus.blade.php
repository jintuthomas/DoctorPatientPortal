                ...
                <div class="card-body">
                  <div class="table-responsive">
					...
					<?php
						...
						$user=DB::table('tbl_leaves')->where('email',$id)->get();
						$counter = 0;
						foreach($user as $a)
						{ 
						  $l_id=$a->l_id;
					...
					?>                      
                        <tr>
						  ...
						  if($status==0)
						  {
                            echo "<td><img src='../../doctor/dist/img/aa2.png' width=50px' height='30px' data-toggle='tooltip' title='Pending'></i></td>";
						  }
						  elseif($status==1)
						  {
                            echo "<td><img src='../../doctor/dist/img/aa1.png' width=50px' height='30px' data-toggle='tooltip' title='Approved'></i></td>";
						  }
						  elseif($status==2)
						  {
                            echo "<td><img src='../../doctor/dist/img/aa3.png' width=50px' height='30px' data-toggle='tooltip' title='Rejected'></td>";
						  }
