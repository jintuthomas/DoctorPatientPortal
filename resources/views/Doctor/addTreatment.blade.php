...
<div class="container">
<div class="reciept">
				<form action="/add" method="post"  enctype="multipart/form-data" novalidate="novalidate" >
	...
	<div class="row">
	 ...
	 <div class="row">
		<div class="col-md-12">
			...
			<label class="col-md-6 control">Disease :</label>
      <div class="col-md-12" style="padding-left:20px;">
			<textarea rows="3" cols="10" name="diseases" class="form-control">
			</textarea></div>
                             ...
                             <div class="table-responsive">  
                                  <table class="table table-bordered" id="dynamic_field">  
									 ...
									 <input type="hidden" name="d_id" value="<?php echo $d_id ;?>" />
                                       <td><input type="text" name="name[]" placeholder="Medicine" class="form-control name_list" /></td>
									  ...
									  <!-- <td><input type="checkbox" name="s[]" value="mng">Mng</td>
									   <td><input type="checkbox" name="s[]" value="mng">Mng</td>
									  <!-- <td><input type="checkbox" name="s[]" value="mng">Mng</td>
									   <td><input type="checkbox" name="s[]" value="evg">EVG</td>
									   <td><input type="checkbox" name="s[]" value="noon">Noon</td>-->
                                        <td><button type="button" name="add" id="add" style="background-color:#fc0c4c;" class="btn btn-success">Add More</button></td>  
                                            </tr>  
                                        </table>  
                                    <div style="margin-left: 750px;"><input type="submit" class="btn btn-info" value="Submit" /> </div>
