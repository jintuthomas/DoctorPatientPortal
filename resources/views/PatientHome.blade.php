...
<body>
                    ...
                    <ul class="rslides" id="slider3">
                        <li>
                            <div class="slider-info">
                               ...
                               <!-- <a class="btn btn-primary mt-3" href="#" role="button">View Details</a>-->
                            </div>
                        </li>
                        <li>
                            <div class="slider-info">
            ...
            <div class="row py-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <a href="single.html">
                                <img class="card-img-bottom" src="patient/images/g5.jpg" alt="Card image cap">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <a href="single.html">
                                <img class="card-img-bottom" src="patient/images/g2.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body border-0 px-0">
                            <div class="blog_w3icon">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <a href="single.html">
                                <img class="card-img-bottom" src="patient/images/g1.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body border-0 px-0">
                            <div class="blog_w3icon">
                            ...
                            <div class="row">
                                    ...
                                    <div class="wthree_testimonials_grid_pos">
                                        <div class="row">
                                            <div class="col-3 grid-test-w3l">
                                                <img src="patient/images/te1.jpg" alt=" " class="img-fluid" />
                                            </div>
                                ...
                                <div class="col-lg-6  wthree_testimonials_grid mt-lg-0 mt-5">
                                    ...
                                    <div class="wthree_testimonials_grid_pos">
                                        <div class="row">
                                            <div class="col-3 grid-test-w3l">
                                                <img src="patient/images/te2.jpg" alt=" " class="img-fluid" />
                                            </div>
                                            <div class="col-9 wthree_testimonials_grid1">
                                                <h5>Michael Paul</h5>
                                                <p>spendisset</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6 wthree_testimonials_grid">
                                    ...
                                    <div class="wthree_testimonials_grid_pos">
                                        <div class="row">
                                            <div class="col-3 grid-test-w3l">
                                                <img src="patient/images/te3.jpg" alt=" " class="img-fluid" />
                                            </div>
                                            <div class="col-9 wthree_testimonials_grid1">
                                                <h5>stibulum</h5>
                                                <p>aliquet</p>
                                ...
                                <div class="col-lg-6  wthree_testimonials_grid mt-lg-0 mt-5">
                                    ...
                                    <div class="wthree_testimonials_grid_pos">
                                        <div class="row">
                                            <div class="col-3 grid-test-w3l">
                                                <img src="patient/images/te4.jpg" alt=" " class="img-fluid" />
                                            </div>
                                            <div class="col-9 wthree_testimonials_grid1">
                                                <h5>stibulum</h5>
                                                <p>puruseu</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6 wthree_testimonials_grid">
                                    ...
                                    <div class="wthree_testimonials_grid_pos">
                                        <div class="row">
                                            <div class="col-3 grid-test-w3l">
                                                <img src="patient/images/te5.jpg" alt=" " class="img-fluid" />
                                            </div>
                                            <div class="col-9 wthree_testimonials_grid1">
                                                <h5>Michael Paul</h5>
                                                <p>Client</p>
    ...
    <script src="patient/js/responsiveslides.min.js"></script>
    <script>
    ...
    <script src="patient/js/jquery.flexisel.js"></script>
    <script>
