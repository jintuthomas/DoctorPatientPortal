...
<head>
  ...
  <link rel="stylesheet" href="doctor/dist/modules/summernote/summernote-lite.css">
  <link rel="stylesheet" href="doctor/dist/modules/flag-icon-css/css/flag-icon.min.css">
...
<body>
              ...
              <div class="card">
                ...
                <div class="card-body">
				  ...
				  <div class="loginBox">
					...
					<table align="center">
                     <tr><center><img src="../../storage/upload/{{$user->photo}}"  height="200px" width="200px"class="user" align="middle"></center></tr>
              ...
              <div class="card">
                ...
                <div class="card-body">             
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="doctor/dist/img/avatar/avatar-1.jpeg" alt="avatar">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="doctor/dist/img/avatar/avatar-2.jpeg" alt="avatar">
                      <div class="media-body">
                        <div class="float-right"><small>10m</small></div>
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="doctor/dist/img/avatar/avatar-3.jpeg" alt="avatar">
                      <div class="media-body">
                        <div class="float-right"><small>10m</small></div>
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="doctor/dist/img/avatar/avatar-4.jpeg" alt="avatar">
                      <div class="media-body">
                        <div class="float-right"><small>10m</small></div>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>                         
                        <tr>
                          ...
                          <td>
                            <a href="#"><img src="doctor/dist/img/avatar/avatar-1.jpeg" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                          </td>
                          <td>
  ...
  <script src="doctor/dist/modules/chart.min.js"></script>
  <script src="doctor/dist/modules/summernote/summernote-lite.js"></script>
